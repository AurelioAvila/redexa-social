...
<div class="wrap">
  ...
  <div class="pricing-head"><h2>Plans</h2><div class="cycle" role="group" aria-label="Billing cycle"><button type="button" class="cycle-btn on" data-cycle="monthly" aria-pressed="true">Monthly</button><button type="button" class="cycle-btn" data-cycle="yearly" aria-pressed="false">Yearly <span class="save">2 months free</span></button></div></div>
  <section class="pricing"><div class="price"><h3>Free</h3><p>Learn the workflow with one connected account.</p><div class="amount"><span data-monthly="€0" data-yearly="€0">€0</span> <small data-monthly="forever" data-yearly="forever">forever</small></div><ul><li>One account</li><li>Core overview</li><li>Local storage</li></ul><a class="btn ghost" data-growth="download_click" href="${DOWNLOAD_URL}">Download free</a></div><div class="price featured"><h3>Pro</h3><p>For creators building a repeatable publishing system.</p><div class="amount"><span data-monthly="€7.99" data-yearly="€79.90">€7.99</span> <small data-monthly="/ month" data-yearly="/ year">/ month</small></div><ul><li>Up to three accounts</li><li>Full history and exports</li><li>Advanced insights</li></ul><a class="btn primary" data-growth="download_click" href="${DOWNLOAD_URL}">Get Redexa Social</a></div><div class="price"><h3>Studio</h3><p>For teams managing a wider portfolio.</p><div class="amount"><span data-monthly="€10.99" data-yearly="€109.90">€10.99</span> <small data-monthly="/ month" data-yearly="/ year">/ month</small></div><ul><li>Up to ten accounts</li><li>Everything in Pro</li><li>Built for multi-brand work</li></ul><a class="btn ghost" data-growth="download_click" href="${DOWNLOAD_URL}">Download the app</a></div></section>
