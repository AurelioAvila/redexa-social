...
def main() -> None:
    ...
    png_256 = png_bytes(master, 256)
    png_120 = png_bytes(master, 120)
    png_64 = png_bytes(master, 64)
    png_32 = png_bytes(master, 32)
    (ROOT / "docs" / "app-icon-1024.png").write_bytes(png_1024)
    (ROOT / "docs" / "app-icon-512.png").write_bytes(png_512)
    (ROOT / "docs" / "app-icon-256.png").write_bytes(png_256)
    (ROOT / "docs" / "app-icon-120-google-branding.png").write_bytes(png_120)
    (ROOT / "docs" / "favicon-32.png").write_bytes(png_32)
